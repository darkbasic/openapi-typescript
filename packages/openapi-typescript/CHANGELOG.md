...
- [`699ab08`](https://github.com/openapi-ts/openapi-typescript/commit/699ab0896ad25acab293c97a052ba6582e581879) Thanks [@darkbasic](https://github.com/darkbasic)! - feat: generate TypeScript with raw string templates and drop the TypeScript dependency
...
'createKeywordTypeNode')` crash,
  ...
  - preserves the fork's read/write helper and required-only `allOf` semantics,
    including callable and readonly collection handling.
...
- [`e2e830e`](https://github.com/openapi-ts/openapi-typescript/commit/e2e830e879276ed420c1b7fda60dcae5901c2f69) Thanks [@darkbasic](https://github.com/darkbasic)! - Generate required composed properties from required-only `allOf` members, including typed object constraints when custom transforms are configured.
...
- [`f6960fe`](https://github.com/openapi-ts/openapi-typescript/commit/f6960fe64aef0124f9547735c20a934c7a7667ed) Thanks [@darkbasic](https://github.com/darkbasic)! - Pin Redocly OpenAPI core to a release that uses patched YAML and glob dependencies and avoids the vulnerable URI parser.

- [`219be04`](https://github.com/openapi-ts/openapi-typescript/commit/219be04e522ab44c0fcd7b8b48cfbd3be237e8f1) Thanks [@darkbasic](https://github.com/darkbasic)! - Support TypeScript 6 alongside TypeScript 5.
