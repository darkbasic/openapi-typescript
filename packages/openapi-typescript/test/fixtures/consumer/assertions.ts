...
import type { components as AllOfComponents } from "./allof.js";
...
const company: AllOfComponents["schemas"]["RequiredCompany"] = { name: "company" };
// @ts-expect-error required-only allOf constraints must remain enforced
const missingName: AllOfComponents["schemas"]["RequiredCompany"] = {};
